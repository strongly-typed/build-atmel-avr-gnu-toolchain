...
# Get sources
VERSION=3.6.1
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/build-avr8-gnu-toolchain-git.sh"
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/avr-binutils.tar.bz2" -P ${DOWNLOAD}
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/avr-gcc.tar.bz2"      -P ${DOWNLOAD}
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/avr-gdb.tar.bz2"      -P ${DOWNLOAD}
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/avr-libc.tar.bz2"     -P ${DOWNLOAD}
wget --quiet "http://distribute.atmel.no/tools/opensource/Atmel-AVR-GNU-Toolchain/${VERSION}/avr8-headers.zip"     -P ${SRC}/headers
